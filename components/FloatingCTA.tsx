    ...
    return (
        <>
            ...
            <div className="md:hidden fixed bottom-0 left-0 w-full z-50 bg-white border-t border-gray-200 shadow-[0_-4px_10px_-1px_rgba(0,0,0,0.1)] flex justify-between items-center px-4 py-2 pb-safe">
                <a href={CALENDAR_URL} target="_blank" rel="noopener noreferrer" className="flex flex-col flex-1 items-center justify-center p-1 text-forest hover:text-saffron transition-colors">
            ...
            <div className="hidden md:flex fixed z-50 flex-col-reverse items-center gap-3 transition-all duration-300 bottom-6 left-6">
                ...
                <button
                    ...
                    className={`w-14 h-14 rounded-full bg-[var(--yellow)] text-[var(--purple)] shadow-2xl flex items-center justify-center transition-transform duration-300 hover:scale-105 z-50`}
                ...
                <div className={`flex flex-col-reverse gap-3 transition-all duration-300 origin-bottom ${isOpen ? 'scale-100 opacity-100 mb-2' : 'scale-0 opacity-0 pointer-events-none mb-0 h-0'}`}>
                    {/* Book Appointment */}
                    <a href={CALENDAR_URL} target="_blank" rel="noopener noreferrer" className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-[var(--yellow)] text-[var(--purple)] shadow-lg hover:scale-110 transition-transform disabled:opacity-50">
                    ...
                    {/* Phone */}
                    <a href="tel:+919043020764" className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-[var(--yellow)] text-[var(--purple)] shadow-lg hover:scale-110 transition-transform">
                    ...
                    {/* WhatsApp */}
                    <a href="https://wa.me/919043020764" target="_blank" rel="noopener noreferrer" className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-[var(--yellow)] text-[var(--purple)] shadow-lg hover:scale-110 transition-transform">
