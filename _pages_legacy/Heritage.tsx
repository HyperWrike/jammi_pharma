...
const Heritage: React.FC = () => {
  ...
  const { content: cmsContent } = useCMSContent('heritage');

  const founderImage = cmsContent?.content?.founderImage || "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?q=80&w=2670&auto=format&fit=crop";
  const galleryImg1 = cmsContent?.content?.galleryImg1 || "https://images.unsplash.com/photo-1579308638162-8e12470762cb?q=80&w=2670&auto=format&fit=crop";
  const galleryImg2 = cmsContent?.content?.galleryImg2 || "https://images.unsplash.com/photo-1631557088921-665aa0808cf7?q=80&w=2670&auto=format&fit=crop";
  const galleryImg3 = cmsContent?.content?.galleryImg3 || "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?q=80&w=2670&auto=format&fit=crop";
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-primary/5 border border-primary/10 mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
             ...
             <span className="text-primary font-black tracking-[0.2em] uppercase text-[10px]">
                <LiveEditable collection="content" docId="heritage" field="heroEst">Est. 1890</LiveEditable>
             </span>
          </div>
          ...
          <h1 className="font-display text-5xl md:text-8xl text-secondary leading-[1.05] mb-10 font-black tracking-tight animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
            <LiveEditable collection="content" docId="heritage" field="heroHeadline">A Legacy of Healing</LiveEditable>
          </h1>
          ...
          <p className="text-xl md:text-2xl text-slate-600/80 max-w-2xl mx-auto leading-relaxed font-serif italic animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            <LiveEditable collection="content" docId="heritage" field="heroSubtext" multiline>Honoring the visionary founder, Dr. Jammi Venkataramanayya. Over a century of bridging ancient Ayurvedic wisdom with the rigor of modern science to serve humanity.</LiveEditable>
          </p>
          ...
          <div className="mt-16 flex flex-col sm:flex-row justify-center gap-6 w-full sm:w-auto px-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
            <a href="#milestones" className="inline-block bg-secondary text-white px-12 py-5 rounded-full font-black uppercase tracking-widest text-xs hover:bg-forest transition-all shadow-2xl shadow-secondary/20 hover:-translate-y-1 active:scale-95">
              <LiveEditable collection="content" docId="heritage" field="heroBtn1">Explore Our Journey</LiveEditable>
            </a>
            <button className="group relative px-12 py-5 rounded-full font-black uppercase tracking-widest text-xs text-secondary overflow-hidden transition-all active:scale-95">
               ...
               <span className="relative z-10"><LiveEditable collection="content" docId="heritage" field="heroBtn2">View Archival Gallery</LiveEditable></span>
            </button>
          </div>
        </div>
      </section>
        ...
        <div className="order-2 lg:order-1 relative group">
          ...
          <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white">
            <h3 className="text-xl font-bold text-secondary font-display mb-1">
              <LiveEditable collection="content" docId="heritage" field="founderName">Dr. Jammi Venkataramanayya</LiveEditable>
            </h3>
            <p className="text-sm text-slate-500 font-bold uppercase tracking-wider">
              <LiveEditable collection="content" docId="heritage" field="founderSubtitle">The Visionary Founder</LiveEditable>
            </p>
          </div>
        </div>
        <div className="order-1 lg:order-2 space-y-6">
          <span className="text-primary font-bold tracking-widest uppercase text-sm">
            <LiveEditable collection="content" docId="heritage" field="founderEyebrow">The Architect of Modern Ayurveda</LiveEditable>
          </span>
          <h2 className="text-4xl md:text-5xl font-display font-bold text-secondary leading-tight">
            <LiveEditable collection="content" docId="heritage" field="founderTitle">A Life Dedicated to Healing</LiveEditable>
          </h2>
          <p className="text-lg text-slate-600 leading-relaxed">
            <LiveEditable collection="content" docId="heritage" field="founderText1" multiline>In the late 19th century, when modern medicine was still in its infancy in India, Dr. Jammi Venkataramanayya embarked on a mission to democratize the profound healing wisdom of Ayurveda.</LiveEditable>
          </p>
          <p className="text-lg text-slate-600 leading-relaxed">
            <LiveEditable collection="content" docId="heritage" field="founderText2" multiline>Recognizing the need for standardization, he became one of the first practitioners to introduce scientific rigor into the preparation of Ayurvedic formulations, ensuring consistent quality and efficacy for every patient.</LiveEditable>
          </p>
          <blockquote className="border-l-4 border-primary pl-6 py-2 my-8">
            <p className="text-xl font-display italic text-secondary leading-snug">
              "<LiveEditable collection="content" docId="heritage" field="founderQuote" multiline>True healing occurs only when the ancient texts are honored with modern precision.</LiveEditable>"
            </p>
          </blockquote>
        </div>
      </section>
        ...
        <div className="max-w-[960px] mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-secondary mb-4">
              <LiveEditable collection="content" docId="heritage" field="milestonesTitle">A Century of Milestones</LiveEditable>
            </h2>
              ...
              <div key={milestone.year} className={`relative flex flex-col md:flex-row gap-8 md:gap-12 mb-16 items-start md:items-center ${idx % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                ...
                <div className={`md:w-1/2 text-left pl-12 md:pl-0 ${idx % 2 === 0 ? 'md:text-left' : 'md:text-right'}`}>
                  <span className="text-4xl lg:text-5xl font-extrabold text-[#E8D5B5] font-display opacity-50 block mb-2">
                    <LiveEditable collection="content" docId="heritage" field={`${milestone.field}Year`}>{milestone.year}</LiveEditable>
                  </span>
                </div>
                ...
                <div className="md:w-1/2 pl-12 md:pl-0">
                  <div className={`bg-background-light p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow relative ${idx % 2 === 0 ? '' : 'md:ml-auto'}`}>
                    <h3 className="text-xl font-bold mb-2 text-secondary">
                      <LiveEditable collection="content" docId="heritage" field={`${milestone.field}Title`}>{milestone.title}</LiveEditable>
                    </h3>
                    <p className="text-slate-600 leading-relaxed text-sm">
                      <LiveEditable collection="content" docId="heritage" field={`${milestone.field}Desc`} multiline>{milestone.desc}</LiveEditable>
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div>
              <h2 className="font-display text-4xl text-secondary font-bold mb-4">
                <LiveEditable collection="content" docId="heritage" field="galleryTitle">The Archival Gallery</LiveEditable>
              </h2>
              <div className="w-12 h-1 bg-primary rounded-full"></div>
            </div>
            <p className="text-slate-500 max-w-md text-right hidden md:block">
              <LiveEditable collection="content" docId="heritage" field="galleryDesc" multiline>Glimpses into the foundational days of Jammi Pharmaceuticals.</LiveEditable>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group relative overflow-hidden rounded-2xl shadow-lg aspect-square">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8 pointer-events-none">
                <p className="text-primary text-xs font-bold uppercase tracking-widest mb-1 pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g1Date">Circa 1905</LiveEditable>
                </p>
                <h3 className="text-white text-xl font-bold font-display pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g1Title">Sacred Formulations</LiveEditable>
                </h3>
                <p className="text-white/70 text-sm mt-2 line-clamp-2 pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g1Desc" multiline>Original handwritten notes documenting precise ingredient ratios for potent remedies.</LiveEditable>
                </p>
              </div>
            </div>
            <div className="group relative overflow-hidden rounded-2xl shadow-lg aspect-[3/4] md:aspect-square">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8 pointer-events-none">
                <p className="text-primary text-xs font-bold uppercase tracking-widest mb-1 pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g2Date">Circa 1920</LiveEditable>
                </p>
                <h3 className="text-white text-xl font-bold font-display pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g2Title">Apothecary Dispensary</LiveEditable>
                </h3>
                <p className="text-white/70 text-sm mt-2 line-clamp-2 pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g2Desc" multiline>First-generation glass tincture bottles used for storing delicate active botanical extracts.</LiveEditable>
                </p>
              </div>
            </div>
            <div className="group relative overflow-hidden rounded-2xl shadow-lg aspect-square">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8 pointer-events-none">
                <p className="text-primary text-xs font-bold uppercase tracking-widest mb-1 pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g3Date">Circa 1965</LiveEditable>
                </p>
                <h3 className="text-white text-xl font-bold font-display pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g3Title">The First Laboratory</LiveEditable>
                </h3>
                <p className="text-white/70 text-sm mt-2 line-clamp-2 pointer-events-auto">
                    <LiveEditable collection="content" docId="heritage" field="g3Desc" multiline>Our shift into standardized mass production while maintaining strict clinical protocols.</LiveEditable>
                </p>
              </div>
            </div>
          </div>
