...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const result = await convexQuery("functions/federation_posts:listFederationPosts", cleanArgs({ status, page, limit }));
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const data = await convexMutation("functions/federation_posts:createFederationPost", payload);
